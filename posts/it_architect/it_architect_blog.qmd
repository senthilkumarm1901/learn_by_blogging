...
1. **The Foundation: Client, Server, and Database** — *How a request travels and where it goes*
...
**What it is:** Three communication models that differ on two axes — **who can initiate** a message, and **how long the connection stays open**.
