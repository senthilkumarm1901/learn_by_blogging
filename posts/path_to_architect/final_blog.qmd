...
## 0. Business Requirements Understanding: The "Problem Framing Frontend" to Architecture Decisions
...
### How to Extract the Requirements - The `Phantom Sketch Artist` Technique
...
### A note on informal power: `Political Capital` and the `HIPPO` effect
