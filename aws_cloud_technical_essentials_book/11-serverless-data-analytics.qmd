...
| 2 | How do **clients** get in? | **Amazon API Gateway** | [10.3](#sec-frontdoor) |
| 3 | **Server**:What runs the business logic? | **AWS Lambda** | [10.4](#sec-compute) |
| 4 | **Data**: Where does state live? | **Amazon DynamoDB** | [10.5](#sec-data) |
| 5 | How do components stay **decoupled?** | DynamoDB Streams → Lambda → **Amazon SNS** | [10.6](#sec-decouple) |
| 6 | How do we absorb **bursts** and cut **latency?** | API Gateway → **Amazon SQS** → Lambda | [10.7](#sec-async) |
| 7 | How is every hop **secured?** | AWS WAF + IAM/Cognito + KMS + Secrets Manager | [10.8](#sec-security) |
| 8 | **Logging**: How do we see what is happening? | **Amazon CloudWatch** + AWS X-Ray | [10.9](#sec-observability) |
| 9 | **Optimization**: How do we tune cost and performance? | DynamoDB DAX + Lambda Power Tuning + Lambda Powertools | [10.10](#sec-optimize) |
...
## 11.2 Turn requirements into architectural drivers {#sec-drivers}
...
## 11.3 Ingest the clickstream {#sec-ingest}
...
## 11.4 Store it in a data lake {#sec-store}
...
## 11.6 Visualise the insight {#sec-visualise}
...
## 11.7 Secure every stage {#sec-secure}
...
## 11.8 Make the pipeline observable {#sec-observability}
...
## 11.9 Make it replicable and resilient {#sec-resilient}
...
## 11.10 Optimise cost and performance {#sec-optimize}
