...
| --- | --- | --- | --- |
| 1 | **Motivation**: Why split into multiple accounts? | Multi-account strategy | [13.2](#sec-drivers) |
| 2 | **Account Structure**: How do we group and control them? | **AWS Organizations + OUs + SCPs** | [13.3](#sec-orgs) |
| 3 | **Accesses**: How do people move between accounts safely? | **IAM roles** + **IAM Identity Center** | [13.4](#sec-auth) |
| 4 | **Monitoring**: How do we see everything centrally? | **CloudTrail, Config, VPC Flow Logs, GuardDuty, Security Hub** | [13.5](#sec-logging) |
| 5 | **IAC/DevOps**: How do we make it repeatable and safe by default? | **Control Tower, Service Catalog, CloudFormation, tag policies** | [13.6](#sec-automate) |
...
## 13.2 Why a multi-account strategy? {#sec-drivers}
...
## 13.3 Organise with AWS Organizations, OUs and SCPs {#sec-orgs}
...
## 13.4 Authenticate across accounts {#sec-auth}
...
## 13.5 Log and monitor centrally {#sec-logging}
...
## 13.6 Automate provisioning and enforce guardrails {#sec-automate}
