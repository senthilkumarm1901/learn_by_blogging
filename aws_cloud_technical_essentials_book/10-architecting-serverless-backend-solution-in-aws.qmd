...
| 3 | **Server**:What runs the business logic? | [10.4](#sec-compute) |
| 4 | **Data**: Where does state live? | [10.5](#sec-data) |
...
| 8 | **Logging**: How do we see what is happening? | [10.9](#sec-observability) |
| 9 | **Optimization**: How do we tune cost and performance? | [10.10](#sec-optimize) |
